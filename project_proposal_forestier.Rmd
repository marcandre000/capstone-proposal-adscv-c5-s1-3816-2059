...
tickers_symbol <-  readr::read_csv("tickers_symbol.csv")
tickers_symbol
```
...
symbols <-  readr::read_csv("tickers_dashboard.csv")
...
dashboard_tibble <- dplyr::left_join(full_tibble, tickers_symbol, by="symbol") %>% 
  ...
  dplyr::select(symbol, stock_description, adjusted, variation, var_percent)
dashboard_tibble
